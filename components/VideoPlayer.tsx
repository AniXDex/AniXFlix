...
const SERVERS = [
    { name: "Alok", movie: (id: string) => `https://screenscape.me/embed?tmdb=${id}&type=movie&lan=eng`, show: (id: string, s: number, e: number) => `https://screenscape.me/embed?tmdb=${id}&type=tv&s=${s}&e=${e}&lan=eng` }, // ScreenScape
