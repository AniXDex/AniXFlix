                  ...
                  <div className="flex flex-col gap-3">
                    {filteredEpisodes.slice(0, visibleCount).map((ep: any) => (
                      <Link 
                        ...
                        key={ep.id}
                        className={`group flex flex-row items-center gap-3 p-2 rounded-xl transition-all border border-transparent hover:bg-[#141417] hover:border-white/5 ${ep.episode_number === Number(episode) ? 'bg-[#141417] border-white/5' : ''}`}
                      >
